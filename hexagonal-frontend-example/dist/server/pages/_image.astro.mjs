...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_DzUBTucd.mjs'
    ).then(n => n.V).catch((e) => {
...
}, "/var/www/html/architecture/hexagonal-frontend-example/node_modules/astro/components/Image.astro", void 0);
...
}, "/var/www/html/architecture/hexagonal-frontend-example/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///var/www/html/architecture/hexagonal-frontend-example/dist/client/");
